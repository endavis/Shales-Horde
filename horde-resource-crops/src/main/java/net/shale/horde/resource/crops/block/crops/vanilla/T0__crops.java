...
public class T0__crops {
    public static final Block CROP_RHODONITE = registerBlockWithoutBlockItem("crops/vanilla/crop_rhodonite",
            new T0_rhodonite_crop(FabricBlockSettings
                    .copy(Blocks.WHEAT)
                    .nonOpaque()
                    .noCollision()
            ));
    public static final Block CROP_AIR = registerBlockWithoutBlockItem("crops/vanilla/crop_air",
            new T0_air_crop(FabricBlockSettings
                    .copy(Blocks.WHEAT)
                    .nonOpaque()
                    .noCollision()
            ));
    public static final Block CROP_EARTH = registerBlockWithoutBlockItem("crops/vanilla/crop_earth",
            new T0_earth_crop(FabricBlockSettings
                    .copy(Blocks.WHEAT)
                    .nonOpaque()
                    .noCollision()
            ));
    public static final Block CROP_FIRE = registerBlockWithoutBlockItem("crops/vanilla/crop_fire",
            new T0_fire_crop(FabricBlockSettings
                    .copy(Blocks.WHEAT)
                    .nonOpaque()
                    .noCollision()
            ));
    public static final Block CROP_WATER = registerBlockWithoutBlockItem("crops/vanilla/crop_water",
