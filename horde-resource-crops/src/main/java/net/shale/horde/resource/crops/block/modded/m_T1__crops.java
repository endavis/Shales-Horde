...
public class m_T1__crops {
    public static final Block CROP_SKY_STONE = registerBlockWithoutBlockItem("modded/crop_sky_stone",
            new m_T1_sky_stone_crop(FabricBlockSettings.copy(Blocks.WHEAT)
            ));
