...
public class YellowItemNetherite extends BackpackRenderer {
    public YellowItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_NetheriteBlockRegistry.NETHERITE_YELLOW_BLOCK.getDefaultState()
