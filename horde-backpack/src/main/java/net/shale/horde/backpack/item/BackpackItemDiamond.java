...
public class BackpackItemDiamond extends BackpackRenderer {
    public BackpackItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
...
//                    BB_LeatherBlockRegistry.DIAMOND_BACKPACK_BLOCK.getDefaultState()
