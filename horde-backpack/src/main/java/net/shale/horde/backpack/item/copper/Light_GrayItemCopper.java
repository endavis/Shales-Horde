...
public class Light_GrayItemCopper extends Putdown {
    public Light_GrayItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    protected BlockState getBlock() {
        return BB_CopperBlockRegistry.COPPER_GRAY_BLOCK.getDefaultState();
    }
    @Override
