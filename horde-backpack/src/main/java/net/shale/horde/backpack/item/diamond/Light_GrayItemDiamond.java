...
public class Light_GrayItemDiamond extends BackpackRenderer {
    public Light_GrayItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_DiamondBlockRegistry.DIAMOND_LIGHT_GRAY_BLOCK.getDefaultState()
