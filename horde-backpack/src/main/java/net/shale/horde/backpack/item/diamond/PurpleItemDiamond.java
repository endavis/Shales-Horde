...
public class PurpleItemDiamond extends BackpackRenderer {
    public PurpleItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_DiamondBlockRegistry.DIAMOND_PURPLE_BLOCK.getDefaultState()
