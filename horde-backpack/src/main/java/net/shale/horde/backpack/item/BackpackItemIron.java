...
public class BackpackItemIron extends BackpackRenderer {
    public BackpackItemIron(Settings settings) {
        super(settings);
    }
    @Override
...
//                    BB_LeatherBlockRegistry.IRON_BACKPACK_BLOCK.getDefaultState()
