...
public class WhiteItemDiamond extends BackpackRenderer {
    public WhiteItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_DiamondBlockRegistry.DIAMOND_WHITE_BLOCK.getDefaultState()
