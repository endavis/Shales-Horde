...
public class PinkItemLeather extends BackpackRenderer {
    public PinkItemLeather(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_LeatherBlockRegistry.LEATHER_PINK_BLOCK.getDefaultState()
