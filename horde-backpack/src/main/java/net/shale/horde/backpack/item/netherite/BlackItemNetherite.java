...
public class BlackItemNetherite extends BackpackRenderer {
    public BlackItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_NetheriteBlockRegistry.NETHERITE_BLACK_BLOCK.getDefaultState()
