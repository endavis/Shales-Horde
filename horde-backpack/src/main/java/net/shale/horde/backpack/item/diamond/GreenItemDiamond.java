...
public class GreenItemDiamond extends BackpackRenderer {
    public GreenItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_DiamondBlockRegistry.DIAMOND_GREEN_BLOCK.getDefaultState()
