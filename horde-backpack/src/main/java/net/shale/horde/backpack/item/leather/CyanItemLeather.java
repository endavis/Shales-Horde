...
public class CyanItemLeather extends BackpackRenderer {
    public CyanItemLeather(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_LeatherBlockRegistry.LEATHER_CYAN_BLOCK.getDefaultState()
