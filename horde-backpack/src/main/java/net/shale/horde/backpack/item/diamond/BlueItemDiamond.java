...
public class BlueItemDiamond extends BackpackRenderer {
    public BlueItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_DiamondBlockRegistry.DIAMOND_BLUE_BLOCK.getDefaultState()
