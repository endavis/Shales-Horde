...
public class BrownItemCopper extends BackpackRenderer {
    public BrownItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_CopperBlockRegistry.COPPER_BROWN_BLOCK.getDefaultState()
