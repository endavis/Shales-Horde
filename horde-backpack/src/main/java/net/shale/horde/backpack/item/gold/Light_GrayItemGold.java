...
public class Light_GrayItemGold extends BackpackRenderer {
    public Light_GrayItemGold(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_GoldBlockRegistry.GOLD_LIGHT_GRAY_BLOCK.getDefaultState()
