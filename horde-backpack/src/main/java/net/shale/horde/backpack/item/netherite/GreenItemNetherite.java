...
public class GreenItemNetherite extends BackpackRenderer {
    public GreenItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_NetheriteBlockRegistry.NETHERITE_GREEN_BLOCK.getDefaultState()
