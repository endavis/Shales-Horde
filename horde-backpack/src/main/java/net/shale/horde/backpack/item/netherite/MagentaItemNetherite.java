...
public class MagentaItemNetherite extends BackpackRenderer {
    public MagentaItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_NetheriteBlockRegistry.NETHERITE_MAGENTA_BLOCK.getDefaultState()
