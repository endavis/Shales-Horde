...
public class Light_GrayItemLeather extends BackpackRenderer {
    public Light_GrayItemLeather(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_LeatherBlockRegistry.LEATHER_LIGHT_GRAY_BLOCK.getDefaultState()
