...
public class YellowItemDiamond extends BackpackRenderer {
    public YellowItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_DiamondBlockRegistry.DIAMOND_YELLOW_BLOCK.getDefaultState()
