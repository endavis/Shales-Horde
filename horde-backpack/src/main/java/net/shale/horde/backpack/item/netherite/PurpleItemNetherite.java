...
public class PurpleItemNetherite extends BackpackRenderer {
    public PurpleItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_NetheriteBlockRegistry.NETHERITE_PURPLE_BLOCK.getDefaultState()
