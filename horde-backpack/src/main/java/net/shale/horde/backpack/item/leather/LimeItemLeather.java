...
public class LimeItemLeather extends BackpackRenderer {
    public LimeItemLeather(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_LeatherBlockRegistry.LEATHER_LIME_BLOCK.getDefaultState()
