...
public class YellowItemCopper extends BackpackRenderer {
    public YellowItemCopper(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_CopperBlockRegistry.COPPER_YELLOW_BLOCK.getDefaultState()
