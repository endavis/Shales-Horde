...
public class OrangeItemCopper extends BackpackRenderer {
    public OrangeItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_CopperBlockRegistry.COPPER_ORANGE_BLOCK.getDefaultState()
