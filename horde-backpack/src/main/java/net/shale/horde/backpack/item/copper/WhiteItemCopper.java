...
public class WhiteItemCopper extends BackpackRenderer {
    public WhiteItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_CopperBlockRegistry.COPPER_WHITE_BLOCK.getDefaultState()
