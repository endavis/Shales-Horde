...
public class Light_BlueItemDiamond extends BackpackRenderer {
    public Light_BlueItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_DiamondBlockRegistry.DIAMOND_LIGHT_BLUE_BLOCK.getDefaultState()
