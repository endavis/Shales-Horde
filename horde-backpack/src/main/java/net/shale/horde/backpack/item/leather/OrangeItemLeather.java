...
public class OrangeItemLeather extends BackpackRenderer {
    public OrangeItemLeather(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_LeatherBlockRegistry.LEATHER_ORANGE_BLOCK.getDefaultState()
