...
public class Light_BlueItemGold extends BackpackRenderer {
    public Light_BlueItemGold(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_GoldBlockRegistry.GOLD_LIGHT_BLUE_BLOCK.getDefaultState()
