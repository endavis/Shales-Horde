...
public class OrangeItemNetherite extends BackpackRenderer {
    public OrangeItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_NetheriteBlockRegistry.NETHERITE_ORANGE_BLOCK.getDefaultState()
