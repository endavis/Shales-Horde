...
public class PinkItemDiamond extends BackpackRenderer {
    public PinkItemDiamond(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_DiamondBlockRegistry.DIAMOND_PINK_BLOCK.getDefaultState()
