...
public class PurpleItemCopper extends Putdown {
    public PurpleItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    protected BlockState getBlock() {
        return BB_CopperBlockRegistry.COPPER_PURPLE_BLOCK.getDefaultState();
    }
    @Override
