...
public class MagentaItemCopper extends BackpackRenderer {
    public MagentaItemCopper(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_CopperBlockRegistry.COPPER_MAGENTA_BLOCK.getDefaultState()
