...
public class PinkItemNetherite extends BackpackRenderer {
    public PinkItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_NetheriteBlockRegistry.NETHERITE_PINK_BLOCK.getDefaultState()
