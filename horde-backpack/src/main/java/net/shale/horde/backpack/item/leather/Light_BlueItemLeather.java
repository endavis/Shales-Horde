...
public class Light_BlueItemLeather extends BackpackRenderer {
    public Light_BlueItemLeather(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_LeatherBlockRegistry.LEATHER_LIGHT_BLUE_BLOCK.getDefaultState()
