...
public class CyanItemNetherite extends BackpackRenderer {
    public CyanItemNetherite(Settings settings) {
        super(settings);
    }
    @Override
        ...
        if (player.isInSneakingPose()) {
            ...
            if (world.getBlockState(blockPos).equals(Blocks.AIR.getDefaultState())) {
                world.setBlockState((blockPos),
                        BB_NetheriteBlockRegistry.NETHERITE_CYAN_BLOCK.getDefaultState()
