...
public class Light_BlueItemCopper extends BackpackRenderer {
    public Light_BlueItemCopper(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_CopperBlockRegistry.COPPER_LIGHT_BLUE_BLOCK.getDefaultState()
