...
public class Light_BlueItemIron extends BackpackRenderer {
    public Light_BlueItemIron(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (player.isInSneakingPose()) {
            ...
            world.setBlockState((blockPos),
                    BB_IronBlockRegistry.IRON_LIGHT_BLUE_BLOCK.getDefaultState()
